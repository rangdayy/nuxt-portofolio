<template>
  <div class="relative  rounded-3xl">
    <NuxtImg :src="`data:image/svg+xml;utf8,${encodeURIComponent(svgMap)}`" class="pointer-events-none size-full select-none [mask-image:linear-gradient(to_bottom,transparent,white_10%,white_90%,transparent)]" alt="world map" height="495" width="1056" :draggable="false" />
...
const map = new DottedMap({ width: 100, grid: "vertical",
 countries: ["IDN"]
 });
